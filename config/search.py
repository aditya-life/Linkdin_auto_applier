...
search_terms = ["Full Stack Developer", "React Developer", "Node.js Developer", "MERN Stack Developer", "Laravel Developer", "React Native Developer"]
...
switch_number = 9                 # Only numbers greater than 0... Don't put in quotes
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", "Embedded Programming", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
